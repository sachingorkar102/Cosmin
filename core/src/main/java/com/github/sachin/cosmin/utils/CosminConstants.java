...
public class CosminConstants {
    ...
    public static final List<String> COMPATIBLE_VERSIONS_POST_NETHER_UPDATE = Arrays.asList("v1_16_R1","v1_16_R2","v1_16_R3","v1_17_R1","v1_18_R1","v1_18_R2","v1_19_R1","v1_19_R2","v1_19_R3");
